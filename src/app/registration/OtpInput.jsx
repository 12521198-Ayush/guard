      ...
      <div className="flex justify-center space-x-2 sm:space-x-4">
        {otp.map((digit, index) => (
          <input
            ...
            onPaste={handlePaste}
            className="h-12 w-12 sm:h-14 sm:w-14 text-xl text-center border-2 border-gray-300 dark:border-gray-600 rounded-md outline-none transition-all duration-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-300 dark:focus:border-blue-400 dark:focus:ring-blue-600 bg-gray-100 dark:bg-gray-700 text-black dark:text-white"
            placeholder="●"
          />
        ))}
      </div>
