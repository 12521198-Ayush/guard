    ...
    <>
      <div className="py-3 px-2 font-sans">
          <div className="flex justify-center mb-3">
              <h2 className="text-lg font-semibold text-center text-gray-700 mb-4">Tickets In-Progress</h2>
          </div>
          <div className="space-y-2 overflow-y-auto" style={{ height: '100vh' }}>
            {tickets.map((ticket: any) => (
              ...
              >
                {/* Ticket Info */}
                <TicketCard ticket={ticket} showStatus={true} showVendor={true} showIcon={false} />
                ...
                <div className="flex justify-start gap-1 p-1">
                  ...
                  <IconButton
                    onClick={() => {
                      ...
                      setNewStauts("temporarily_parked");
                    }}
                    className="!p-2 border border-orange-200 bg-orange-50 hover:bg-orange-100 rounded-full transition"
                  >
                    <PauseOutlinedIcon sx={{ color: orange[600] }} fontSize="small" />
                  </IconButton>     
