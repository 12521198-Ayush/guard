                                    ...
                                    <div className="mb-4">
                                        ...
                                        <CardContent className="grid gap-4">
                                            <input type="email" placeholder="Email" name="email" className=
                                                'w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 text-black outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary'></input>
...
function LoginButton() {
    ...
    return (
        <button
            ...
            disabled={pending} // Disable the button based on state
        >
            Login
        </button>
    );
