                        ...
                        <div className="mx-auto">
                            ...
                            >
                                ...
                                {step === 1 && (
                                    <>
                                        <Input
                                            style={{ height: '3.5rem', borderRadius: '8px', border: '1px solid #d9d9d9' }}
                                            placeholder="Name"
                                            className="mb-4 w-full border border-gray-300 rounded-lg px-4 py-2 text-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition duration-200"
                                            value={name}
                                        ...
                                        <div className="mb-4 w-full">
                                            <Input
                                                ...
                                                className={`w-full mb-2 px-4 py-2 border rounded-lg text-lg transition duration-200 ${error ? "border-red-500" : "border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200"}`}
                                                value={email}
                                ...
                                {step === 2 && (
                                    <>
                                        ...
                                        <button
                                            className="mt-2 tracking-wide font-semibold py-3 bg-gray-300 text-black w-full rounded-lg hover:bg-gray-400 transition-all duration-300 ease-in-out"
                                            onClick={prevStep}
                                        >
                                            Back
                                        </button>
