        ...
        <div className="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          ...
          <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
            ...
            <div className="mt-4">
              ...
              {/* <p>Premise Name: {session?.user?.premises_associated_with[0]?.premise_name || 'N/A'}</p> */}
              {/* <p>Admin Name: {session?.user?.premises_associated_with[0]?.admin_name || 'N/A'}</p> */}
              {/* <p>Admin Designation: {session?.user?.premises_associated_with[0]?.admin_designation || 'N/A'}</p> */}
              {/* <p>Admin Email: {session?.user?.premises_associated_with[0]?.admin_email || 'N/A'}</p> */}
