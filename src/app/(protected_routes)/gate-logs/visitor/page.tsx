...
const VisitorLogs = () => {
    ...
    const skills: any[] = ['Cabs', 'Delivery', 'Guest'];
    ...
    const fetchLogs = async () => {
        ...
        // Visitor Type
        let visitor_type = form.getFieldValue("visitor_type") ? form.getFieldValue("visitor_type").trim() : "";
        if (visitor_type == "" ){
        ...
        // Vehicle No.
        let vehicle_number = form.getFieldValue("vehicle_no") ? form.getFieldValue("vehicle_no").trim() : "";
        if (vehicle_number == "" ){
        ...
        const payload = {
            ...
            premise_unit_id: unit_id, //optional
            guest_type: visitor_type,//optional
            guest_vehicle : vehicle_number,//optional
            //guest_mobile:'',//optional
            //scan_mode:'', //optional
            //scan_type: '', //optional
            //scan_location: '', //optional
        ...
        try {
            const response = await axios.post(
                'http://139.84.166.124:8060/user-service/visitor/logs/read',
                payload,
                {
                    headers: {
    ...
    const columns = [
        {
            ...
            render: (_: any, record: any) => {
                return <span>
                    <div className="m-0 p-0 flex-wrap items-center justify-center">
            ...
            <Form form={form}>
                <div className="px-4 py-4 w-full flex flex-wrap justify-between">
                    <div className="w-8/12 md:w-12/12 flex flex-wrap gap-3 justify-start">
                        ...
                        {/* Visitor Type Select */}
                        <Form.Item name="visitor_type" className='p-0 m-0'>
                            <Select
