    ...
    <div className="flex justify-center space-x-2 sm:space-x-4">
      {otp.map((digit, index) => (
        <input
          ...
          className="border-gray-300 bg-gray-100 dark:border-gray-400 dark:bg-gray-500 h-6 w-6 min-w-[18px] rounded-md border-2 text-center text-xl text-black outline-none transition focus:border-primary focus:ring-2 focus:ring-primary/50 dark:text-white sm:h-14 sm:w-10"
          placeholder="•"
        />
      ))}
    </div>
