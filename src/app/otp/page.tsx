...
export default function LoginPage() {
    ...
    return (
        <LoginLayout>
            <div className="flex h-screen overflow-hidden relative flex-1 flex-col mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
                    ...
                    <div className="flex flex-wrap items-center">
                        ...
                        <div className="w-full xl:w-1/2 xl:border-l-2 border-stroke dark:border-strokedark">
                            <div className="p-4 sm:p-8 lg:p-12">
                                ...
                                {/* Title */}
                                <h2 className="mb-6 text-center text-xl font-bold text-black dark:text-white sm:text-2xl lg:text-3xl">
                                    SERVIZING
                                </h2>
                                ...
                                <div className="mb-4">
                                    ...
                                    <CardFooter className="flex flex-col space-y-4">
                                        {otpFieldVisible ? (
                                            <>
                                                ...
                                                {/* <button
                                                    ...
                                                    className="w-full cursor-pointer rounded-lg border border-primary bg-primary py-2 text-white transition hover:bg-opacity-90"
                                                >
                                                    Login
                                                </button> */}
                                                <Button
                                                    ...
                                                    className="w-full"
                                                    style={{
                                                        background: 'linear-gradient(90deg, #4e92ff, #1e62d0)', // Blue gradient for Login
                                                        color: 'white',
                                                        marginLeft: '8px',
                                                        border: 'none',
                                                        marginRight: '4px',
                                                        borderRadius: '10px',
                                                        padding: '19px 12px', // Increased vertical padding (top and bottom)
                                                ...
                                                <Button
                                                    ...
                                                    style={{
                                                        backgroundColor: isDisabled ? 'pink' : 'white',
                                                        color: isDisabled ? 'white' : 'black', // Red gradient for Cancel
                                                        marginLeft: '8px',
                                                        border: 'none',
                                                        marginRight: '4px',
                                                        borderRadius: '4px',
                                        ...
                                        {/* Login via Password Button */}
                                        {/* <Button onClick={LoginviaPass} className="w-full">
                                            Login via Password
                                        </Button> */}

                                        <Button
                                            onClick={LoginviaPass}
                                            style={{
                                                background: 'linear-gradient(90deg, #4e92ff, #1e62d0)', // Red gradient for Cancel
                                                color: 'white',
                                                marginLeft: '8px',
