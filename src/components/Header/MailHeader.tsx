...
const MailHeader = (props: {
  ...
  return (
    <header className="sticky top-0 z-999 flex w-full bg-white ">
      <div className="flex flex-grow items-center justify-between py-5 px-2">
        ...
        <div className=" mr-auto flex items-center gap-2 sm:gap-4 lg:hidden">
          ...
          <button
            ...
            className="z-99999 block rounded-sm ml-auto border border-stroke bg-white p-1.5 shadow-sm dark:border-strokedark dark:bg-boxdark lg:hidden"
          >
            <span className="relative block h-5.5 w-5.5 cursor-pointer">
              ...
              <span className=" right-0 h-full w-full rotate-45">
                <span
                  className={` left-2.5 top-0 block h-full w-0.5 rounded-sm bg-black delay-300 duration-200 ease-in-out dark:bg-white ${!props.sidebarOpen && "!h-0 !delay-[0]"
                    }`}
                ></span>
                <span
