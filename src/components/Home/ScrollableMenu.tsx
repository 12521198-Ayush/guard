...
const menuItems = [
    ...
    { icon: <img width="64" height="64" src="https://img.icons8.com/external-flaticons-flat-flat-icons/512w/external-visitor-internet-marketing-service-flaticons-flat-flat-icons.png" alt="external-visitors-hospitality-services" />, label: "Visitors Logs", path: "/visitors" },
    { icon: <img width="64" height="64" src="https://img.icons8.com/external-wanicon-lineal-color-wanicon/64/external-maid-labour-day-wanicon-lineal-color-wanicon.png" alt="external-maid-labour-day-wanicon-lineal-color-wanicon"/>, label: "Maid Logs", path: "/maids" },
